...
Formation1.CalculerMoyenneFormation();
Formation2.CalculerMoyenneFormation();
Formation3.CalculerMoyenneFormation();
...
console.log(Formation1.CalculerMoyenneFormation());
console.log(Formation2.CalculerMoyenneFormation());
console.log(Formation3.CalculerMoyenneFormation());
